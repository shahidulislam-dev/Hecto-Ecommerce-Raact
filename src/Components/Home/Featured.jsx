    ...
    <section className="pt-12 pb-28">
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap justify-between">
          {data.map((item)=>(
            <div className="w-[23%] shadow-lg group relative mb-5">
            <div className="flex justify-center pt-20 pb-5 bg-[#F6F7FB] relative transition-all duration-300 group-hover:pt-16 group-hover:pb-10">
              ...
              <img
                src={item.thumbnail}
                alt="Product Image"
                className="transition-transform duration-300 group-hover:scale-90 w-48 h-48"/>
            ...
            <div className="flex flex-col items-center py-6 bg-white transition-colors duration-300 group-hover:bg-secondery">
              <h4 className="font-lato font-bold text-primary text-[18px] group-hover:text-white">{item.title}</h4>
              ...
              <p className="pt-3 font-josef text-[14px] text-secondery group-hover:text-white">Code - {item.sku}</p>
              <p className="pt-3 font-josef text-[14px] text-secondery group-hover:text-white"> ${item.price}</p>
            </div>
          </div>
          ))}
