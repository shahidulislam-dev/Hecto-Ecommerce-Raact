  ...
  return (
    <section>
      <div className="container mx-auto">
        {data.map((product) => {
          // Code for Showing Selected Image
          if (!selectedImage) {
            ...
            <div key={product.id} className="my-32 flex items-center shadow-shadowArround p-5">
              <div className="w-[50%] flex items-center gap-4">
                <div className="space-y-2">
                  {[...product.images, ...product.images, ...product.images]
                    ...
                    .map((image, index) => (
                      <div
                        key={index}
                        className="bg-slate-300 p-2 w-48 flex justify-center cursor-pointer"
                        onClick={() => setSelectedImage(image)} // Update image on click
                      >
                ...
                <div className="bg-slate-300 p-2 w-[30rem] h-[36rem] flex items-center justify-center">
                  <img src={selectedImage} alt="" className="w-96 h-[28rem]" />
                </div>
              </div>
              ...
              <div className="w-[50%]">
                ...
                <p className="font-josef text-[16px] text-secondery pt-3">
                ...
                <div className="font-josef text-secondery text-[16px] pt-3 flex items-center gap-4 pl-20">
                  <button
                    ...
                    className="hover:bg-secondery hover:text-white px-3 py-2 rounded-md"
                  >
                    Add To Cart
                  </button>
                  <div className="hover:bg-secondery hover:text-white px-3 py-2 rounded-md cursor-pointer">
                    <FaRegHeart />
                  </div>
                </div>
